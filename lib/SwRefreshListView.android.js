...
import { StyleSheet, Text, View, ListView, ActivityIndicator, Animated, Easing, Dimensions, Image, AsyncStorage } from "react-native";
    ...
    render() {
        return (
            <ListView
                ...
                renderFooter={() => this._rendrFooter()}
            />
        );
    }
    //-----------------------上拉加载部分-------------------------------
    ...
    _rendrFooter() {
        if (!this.props.isShowLoadMore) {
            if (!this.props.renderFooter) {
                ...
                return <View>{this.props.renderFooter()}</View>;
            }
        }
